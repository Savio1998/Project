<?php session_start();
       ...
       $vraag = array(
            "Mijn zusje houdt van dansen.",
            "Muziek zit in onze familie.",
            "Zij gaan morgen op vakantie",
            "De juf gaf ons veel huiswerk mee.",
            "De bouwvakkers waren al vroeg begonnen.",
            "Mijn beste vriendin ging met mij naar het pretpark.",
        ...
        for($a = 0; $a<10; $a++){
            if($nummer1 == 0){
                ...
                setcookie("opdr-nl-ond-opdr2", $score, time() + 86400, "/");
                echo '<META HTTP-EQUIV="Refresh" Content="0; URL=/opdrachten/nederlands/onderwerp.php">';    
                exit;   
