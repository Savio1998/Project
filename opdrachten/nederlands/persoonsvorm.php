...
<br>
<div class="row">
<div class="col-md-4"><?php if($_COOKIE['opdr-nl-pers-opdr1'] == 0) { ?><a href="./persoonsvorm/opdrachten1.php">Persoonsvorm Oefeningen 1</a><?php }else{ ?> Persoonsvorm Oefeningen 1 <?php } ?></div>
<div class="col-md-4"></div>
<div class="col-md-4"> <?=isset($_COOKIE["opdr-nl-pers-opdr1"]) ? $_COOKIE['opdr-nl-pers-opdr1'] : 0 ?>/100</div><br>

<div class="col-md-4"><?php if($_COOKIE['opdr-nl-pers-opdr2'] == 0) { ?><a href="./persoonsvorm/opdrachten2.php">Persoonsvorm Oefeningen 2</a><?php }else{ ?> Persoonsvorm Oefeningen 2 <?php } ?></div>
<div class="col-md-4"></div>
