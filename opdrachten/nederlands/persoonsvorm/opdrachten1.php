<?php session_start();
       ...
       $vraag = array(
            "De vakantie duurt niet lang.",
            "De kleine jongen was heel moe.",
            "Jij eet bij je grootouders.",
            "Ik ga met de bus naar school.",
            "Toen ik 5 was begon ik met ballet.",
            "Morgen hebben wij geen school.",
            "Mijn oudere broers gaan elke dag naar de fitness.",
            "Als ik oud genoeg ben wil ik ook met ze mee.",
            "Mijn broertjes spelen de hele dag op hun xbox.",
            "Het meisje had een indrukwekkende auditie."            
        );
        for($e = 0; $e<10; $e++){
        $eindantwoord[$e] = "";
        $eindbericht[$e] = "";
        ...
        for($a = 0; $a<10; $a++){
            if($nummer1 == 0){
                ...
                setcookie("opdr-nl-pers-opdr1", $score, time() + 86400, "/");
