       ...
       $vraag = array(
        ...
        for($a = 0; $a<10; $a++){
            if($nummer1 == 0){
                ...
                setcookie("opdr-nl-zo-pers-n3-opdr3", $score, time() + 86400, "/");
                echo '<META HTTP-EQUIV="Refresh" Content="0; URL=/opdrachten/nederlands/zinsontleding/persoonsvorm/niveau3.php">';    
                exit;   
