       ...
       $vraag = array(
        ...
        for($a = 0; $a<10; $a++){
            if($nummer1 == 0){
                ...
                setcookie("opdr-nl-zo-pers-n1-opdr1", $score, time() + 86400, "/");
                echo '<META HTTP-EQUIV="Refresh" Content="0; URL=/opdrachten/nederlands/zinsontleding/lijdend-voorwerp/niveau1.php">';    
                exit;   
...
<html>
<head>
  <title>Lijdend voorwerp opdrachten 1</title>
  <meta charset="utf-8">
...
<div class="container"> 
 ...
 <h3><b>Lijdend voorwerp</b></h3> 
 <div class="row">
    <div class="col-md-5"><h4><b>Geef het lijdend voorwerp.</b></h4></div><div class="col-md-2"></div><div class="col-md-2"></div><div class="col-md-3"><b>Score:</b> <?=$score?>/100</div>
</div><br>

<div class="row">
    <div class="col-md-5"></div><div class="col-md-3">Lijdend voorwerp</div><div class="col-md-4"></div>
</div>
<div class="row">
