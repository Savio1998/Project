       ...
       $vraag = array(
        ...
        for($a = 0; $a<10; $a++){
            if($nummer1 == 0){
                ...
                setcookie("opdr-nl-zo-ond-n2-opdr2", $score, time() + 86400, "/");
                echo '<META HTTP-EQUIV="Refresh" Content="0; URL=/opdrachten/nederlands/zinsontleding/onderwerp/niveau2.php">';    
                exit;   
