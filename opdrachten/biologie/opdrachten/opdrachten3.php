       ...
       $vraag = array(
        ...
        for($a = 0; $a<10; $a++){
            if($nummer1 == 0){
                ...
                setcookie("opdr-bio-dier-herken-n1-opdr3", $score, time() + 86400, "/");
                echo '<META HTTP-EQUIV="Refresh" Content="0; URL=/opdrachten/biologie/dieren.php">';    
                exit;   
